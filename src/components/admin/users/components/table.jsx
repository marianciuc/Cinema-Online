...
import {Avatar, Button, InputBase, TextField} from "@material-ui/core";
...
const headCells = [
    ...
    { id: 'mainPictureUrl', numeric: false, disablePadding: false, label: 'Avatar' },
    ...
    return (
        <div className={classes.root}>
            ...
            <Paper className={classes.paper}>
                <EnhancedTableToolbar numSelected={selected.length} count={users.users.length} />
                <TableContainer>
                    <Table
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="left"><Avatar alt="Remy Sharp" src={row.mainPictureUrl} /></TableCell>
